...
import org.apache.wave.server.model.undo.UndoManagerImpl;
import org.apache.wave.server.model.undo.UndoManagerImpl.Algorithms;
...
final class UndoManagerFactory {
  ...
  private static final Algorithms<AggregateOperation> algorithms =
      new Algorithms<AggregateOperation>() {
