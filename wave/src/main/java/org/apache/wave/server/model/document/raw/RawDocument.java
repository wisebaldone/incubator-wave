...
import org.apache.wave.server.model.document.DocumentFactory;
...
public interface RawDocument<N, E extends N, T extends N> extends ReadableDocument<N, E, T>,
   ...
   */
  Container<N> getIndexingContainer(N domNode);
   ...
   */
  void setIndexingContainer(N domNode, Container<N> indexingContainer);
