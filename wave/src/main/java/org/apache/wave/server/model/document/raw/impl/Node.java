...
package org.apache.wave.server.model.document.raw.impl;
 ...
 *
 */
public abstract class Node implements N {
  ...
  Node nextSibling;
  private Container<Node> indexingContainer;
   ...
   */
  public Container<Node> getIndexingContainer() {
   ...
   */
  public void setIndexingContainer(Container<Node> indexingContainer) {
