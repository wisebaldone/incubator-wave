...
import org.apache.wave.server.model.schema.account.AccountSchemas;
import org.apache.wave.server.model.schema.supplement.UserDataSchemas;
...
public final class WaveletBasedSupplementTest extends TestCase {
  ...
  public void testCopySnapshotDoesNotCauseWrites() {
    ...
    SupplementedWave swave = SupplementedWaveImpl.create(substrate, view, viewer, DefaultFollow.ALWAYS);
