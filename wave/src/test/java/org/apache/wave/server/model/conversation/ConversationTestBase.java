...
import org.apache.wave.server.model.document.util.DocIterate;
...
import org.apache.wave.server.model.operation.wave.WorthyChangeChecker;
...
public abstract class ConversationTestBase extends TestCase {
  ...
  public void testDeleteInlineReplyDeletesAnchor() {
    ...
    assertBlipInvalid(inlineReplyBlip);
    assertThreadInvalid(inlineReply);
    ExtraAsserts.assertStructureEquivalent(xmlBefore, blip.getContent());
  }
