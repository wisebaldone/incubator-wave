...
import org.apache.wave.server.model.document.util.DocOpScrub.UncheckedAnnotationBoundary;
...
public class DocOpScrubTest extends TestCase {
  ...
  static final String VALID = " abcDEF^#!(_+90" +
      "\u03e0\u042e\u6202\u05f3\u0610\u0710\u3045\u00ee\u0175\u0a00";
  static final String VALID_SCRUBBED = "aaaaaaaaaaaaaaa" + DocOpScrub.PSI + DocOpScrub.JIA + DocOpScrub.WO + "HA?Jbc?";
  ...
  static String leaveInitial(String original, String scrubbed) {
    return original.substring(0, DocOpScrub.CHARS_TO_LEAVE) + scrubbed.substring(
        DocOpScrub.CHARS_TO_LEAVE);
  }
}
